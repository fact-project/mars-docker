...
RUN apt-get update && apt-get install -y  git dpkg-dev make g++ gcc binutils libx11-dev libxpm-dev libxft-dev libxext-dev htop build-essential wget
...
libgsl0-dev libqt4-dev cmake subversion libnova-dev libc6-dev-i386
